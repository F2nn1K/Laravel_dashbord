        ...
        columns: [
               ...
               <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <button type="button" id="btnEdt" class="dropdown-item" data-url="${APP_URL}/outro/edt/id/" data-url-frm="${APP_URL}/outro/upd/id/" data-id="${row.id}"> <i class="bx bx-edit-alt me-1"></i> Editar </button>
                                <button  type="button" id="btnDelete" class="dropdown-item" data-url="${APP_URL}/outro/del/id/" data-tbl-name="tblRelatorio" data-id="${row.id}"> <i class="bx bx-trash me-1"></i> Eliminar </button>
                            </div>
                        </div>
                    `;
                }
