...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('sneat-1.0.0/assets/vendor/fonts/boxicons.css') }}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('sneat-1.0.0/assets/vendor/css/core.css') }}"
        class="template-customizer-core-css" />
    <link rel="stylesheet"
        href="{{ asset('sneat-1.0.0/assets/vendor/css/theme-default.css') }}"
    ...
    <!-- Page -->
    <link rel="stylesheet"
        href="{{ asset('sneat-1.0.0/assets/vendor/css/pages/page-auth.css') }}" />
    <!-- Helpers -->
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="#" class="app-brand-link gap-2">
                                <img src="{{ asset('img/login.png') }}" alt="Logo VSA"
                                    class="w-px-250 h-20" />
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">{{ __('messages.welcome') }}
                            {{ __('messages.to') }} {{ env('APP_NAME') }} 👋</h4>
                        <p class="mb-4">{{ __('messages.please') }}
                            {{ __('messages.sign-in') }} {{ __('messages.to') }}
                            {{ __('messages.your') }} {{ __('messages.account') }}
                        </p>

                        <form id="frmAuth" class="mb-3" action="#" method="POST">
                            <div class="mb-3">
                                <label for="name"
                                    class="form-label">Usuário</label>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit">{{ __('messages.sign-in') }}</button>
                            </div>
                        </form>
    ...
    <script
        src="{{ asset('sneat-1.0.0/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }}">
    </script>
    ...
    <script src="{{ asset('js/Auth/IuViLogin.js') }}"></script>
