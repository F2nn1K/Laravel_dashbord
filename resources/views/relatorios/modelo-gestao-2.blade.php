@extends('layouts.app')
@section('title', 'Modelo de Gestão 2')
@section('css')
@endsection
@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <i class="bx bx-file-blank text-primary"></i> Relatório - Modelo de Gestão 2
    </h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0 text-white"><i class="bx bx-filter me-2"></i>Filtros do Relatório (com Assinatura)</h5>
                </div>
                <div class="card-body">
                    <form id="frmRelatorioGestao2">
                        <div class="row g-3">
...
$(document).ready(function() {
    // Gerar relatório
    $('#frmRelatorioGestao2').on('submit', function(e) {
        e.preventDefault();
        ...
        const url = APP_URL + `/relatorio/modelo-gestao-2/gerar?${params.toString()}`;
